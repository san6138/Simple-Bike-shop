# Generated by Django 4.1.1 on 2023-10-26 03:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('P', 'pending'), ('R', 'ready')], max_length=255)),
                ('bike', models.ForeignKey(default='Not Available Anymore', on_delete=django.db.models.deletion.SET_DEFAULT, to='shop.bike')),
            ],
        ),
        migrations.AddField(
            model_name='bike',
